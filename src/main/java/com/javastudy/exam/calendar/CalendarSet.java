...
public class CalendarSet {
    public static void main(String[] args) {
        final int[] TIME_UNIT = {3600, 60, 1}; // 시, 분, 초 배열 큰 단위를 앞에 놓는다.
        ...
        String tmp = "";
        System.out.println("TIME_UNIT : "+ TIME_UNIT.toString()); // 시분초 배열,
        System.out.println("TIME_UNIT.length : "+ TIME_UNIT.length);
